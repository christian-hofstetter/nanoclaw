    ...
    options: {
      ...
      mcpServers: {
        ...
        'google-calendar': {
          ...
          args: [],
          env: {
            GOOGLE_OAUTH_CREDENTIALS: '/home/node/.google-calendar/gcp-oauth.keys.json',
            GOOGLE_CALENDAR_MCP_TOKEN_PATH: '/home/node/.google-calendar/tokens.json',
          },
        },
        github: {
        ...
        simplinvoice: {
          command: 'bash',
          args: ['-c', 'cd /home/node/mcp-simplinvoice && node dist/index.js'],
        },
        'google-ads': {
